...
print "going to study the Lattice through Brute Force"
sys.stdout.flush()


OrganizationsFoundStudyingAll=CheckAllSubsets(set(molecules))  #this only works if the number of subsets is not too big. If not it does not even starts
#print OrganizationsFoundStudyingAll
